...
export const CORNER_RADIUS = ROLL_NUMBER_RADIUS / 3;
export const CORNER_DELTA_HEIGHT = HEX_SIDE_LENGTH / 4;
export const CORNER_START_X = BOARD_MARGIN_SIDE + HEX_CENTER_X;
